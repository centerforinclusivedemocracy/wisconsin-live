...
const PARTICIPATING_COUNTIES = [
  { countyfp: "009", name: "Brown", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "017", name: "Chippewa", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "021", name: "Columbia", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "025", name: "Dane", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "027", name: "Dodge", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "035", name: "Eau Claire", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "039", name: "Fond du Lac", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "043", name: "Grant", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "055", name: "Jefferson", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "059", name: "Kenosha", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "063", name: "La Crosse", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "071", name: "Manitowoc", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "073", name: "Marathon", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "079", name: "Milwaukee", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "087", name: "Outagamie", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "089", name: "Ozaukee", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "097", name: "Portage", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "101", name: "Racine", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "105", name: "Rock", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "109", name: "St. Croix", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "111", name: "Sauk", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "117", name: "Sheboygan", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "127", name: "Walworth", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "131", name: "Washington", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "133", name: "Waukesha", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "139", name: "Winnebago", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
  { countyfp: "141", name: "Wood", profile: 'fullmodel', outoforder:"", datafootnote: "Voting locations for Wisconsin are modeled at the county level. Future versions on the Siting Tool will include location modeling based on the city and township level.", exceptlayers: [] },
];
...
DATA_LAYERS.four_day_sites = {
    id: 'four_day_sites',
    title: "Suggested Areas for Voting Locations",
...
DATA_LAYERS.additional_sites_model = {
    ...
    title: "Additional Voting Locations Based on Model",
...
DATA_LAYERS.additional_sites_distance = {
    ...
    title: "Additional Voting Locations Based on Distance",
